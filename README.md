...
* [cite_start]**RESTful API Architecture:** High-performance endpoints built with FastAPI[cite: 81].
...
* [cite_start]**Backend Framework:** [FastAPI](https://fastapi.tiangolo.com/) [cite: 81]
* **Database:** [PostgreSQL](https://www.postgresql.org/) via [Supabase](https://supabase.com/)
* **ORM:** [SQLAlchemy](https://www.sqlalchemy.org/)
* **Server/Deployment:** [Render](https://render.com/)
* [cite_start]**Frontend Templating:** Jinja2 [cite: 81]
...
* [cite_start]`requirements.txt`: Python dependency manifest[cite: 81].
...
---
*Documentation generated by Gemini 3 Flash*
